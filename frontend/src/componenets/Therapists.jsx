...
const therapists = [
  ...
  },
  {
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTLXGqwSZZs3OK7U26xHEBf6KQ77X_cCnXCtw&s",
  },
  {
    name: "Dr. Aisha Patel",
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center mb-16">
          ...
          >
            Connect with licensed mental health professionals who can support
